  ...
  let content = (
    ...
    <p>Junior at Rutgers University studying <span style={{ fontWeight: '700' }}>Computer Science</span></p>
        ...
        <ul>
          ...
          <li>SDL2</li>
          <li>GDB</li>
          <li>AWS Lambda, ec2, s3, Cloudfront</li>
          <li>React.js</li>
          <li>Git</li>
          <li>Docker</li>
          <li>Android SDK</li>
        ...
        <p><pre><a href = "https://www.linkedin.com/in/n00rsy/">LinkedIn</a>  <a href = "https://github.com/n00rsy">GitHub</a>  <a href = "https://github.com/n00rsy/site/blob/master/NoorSyedResume.pdf">resume</a></pre></p>

        <h2>Fluff</h2>
        <p>When I'm not writing code, I'm lifting, running, and eating fat sandwiches.</p>
